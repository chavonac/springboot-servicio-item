...
public class ItemServiceImpl implements ItemService {
	...
	public Producto save(Producto producto) {
		...
		ResponseEntity<Producto> reponse = clienteRest.exchange("http://servicio-productos/crear", HttpMethod.POST,
				body, Producto.class);
		Producto productoResponse = reponse.getBody();
	...
	public Producto update(Producto producto, Long id) {
		...
		pathVariables.put("id", id.toString());
		HttpEntity<Producto> body = new HttpEntity<Producto>(producto);
		ResponseEntity<Producto> reponse = clienteRest.exchange("http://servicio-productos/editar/{id}", HttpMethod.PUT,
